    ...
    <>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" id="quoteField" placeholder="Enter here" class="form-control" />
                    </div>

                    <div class="form-group mt-2">
                        <label for="addressField">Your Address</label>
                        <textarea id="addressField" placeholder="Enter here" class="form-control" rows="5️"></textarea>
                    </div>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" id="facebookField" placeholder="Enter here" class="form-control" />
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <textarea id="objectivesField" placeholder="Enter here" class="form-control weField"
                            rows="5"></textarea>
                    </div>
      ...
      <div style={{ display: resumeHidden ? 'none':'block'}}>
        ...
        <main>
          ...
          <header>
            <h1>Nguyen Vo Thuan</h1>
            <p>🚀 Welcome to my website!</p>
          </header>


          <blockquote>
            <p>Something to write in this blockquote, but I didn't find one yet... </p>
          </blockquote>
          ...
          <section>
            ...
            <p>I am a UMass Amherst computer science sophomore. Studying front-end techniques and designing beautiful websites are all my passions.
              <br />
              I am currently hooked on React JS. Hire me! :)
